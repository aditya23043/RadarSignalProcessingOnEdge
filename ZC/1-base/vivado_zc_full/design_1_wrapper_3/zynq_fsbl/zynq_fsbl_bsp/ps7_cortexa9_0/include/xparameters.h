...
/* Definitions for driver TRIGGER_IP */
#define XPAR_XTRIGGER_IP_NUM_INSTANCES 1

/* Definitions for peripheral TRIGGER_IP_0 */
#define XPAR_TRIGGER_IP_0_DEVICE_ID 0
#define XPAR_TRIGGER_IP_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_TRIGGER_IP_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral TRIGGER_IP_0 */
#define XPAR_XTRIGGER_IP_0_DEVICE_ID XPAR_TRIGGER_IP_0_DEVICE_ID
#define XPAR_XTRIGGER_IP_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_XTRIGGER_IP_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF
