...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "doppler_fft_256.autotvin.dat"
	set constFileTvOut       "doppler_fft_256.autotvout.dat"
	set constFileHdlTvIn     "doppler_fft_256.autohdltvin.dat"
	set constFileHdlTvOut    "doppler_fft_256.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
