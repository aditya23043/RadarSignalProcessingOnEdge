set moduleName doppler_fft_256_Pipeline_VITIS_LOOP_66_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {doppler_fft_256_Pipeline_VITIS_LOOP_66_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ range_dop_map_M_value float 32 regular {array 256 { 1 3 } 1 1 }  }
	{ range_dop_map_M_value_1 float 32 regular {array 256 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "range_dop_map_M_value", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "range_dop_map_M_value_1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set Spec2ImplPortList { 
	range_dop_map_M_value { ap_memory {  { range_dop_map_M_value_address0 mem_address 1 8 }  { range_dop_map_M_value_ce0 mem_ce 1 1 }  { range_dop_map_M_value_q0 in_data 0 32 } } }
	range_dop_map_M_value_1 { ap_memory {  { range_dop_map_M_value_1_address0 mem_address 1 8 }  { range_dop_map_M_value_1_ce0 mem_ce 1 1 }  { range_dop_map_M_value_1_q0 in_data 0 32 } } }
