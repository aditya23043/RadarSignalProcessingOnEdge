...
#define CONTROL_ADDR_SYNC_RESET_DATA   0x10
#define CONTROL_BITS_SYNC_RESET_DATA   1
#define CONTROL_ADDR_TRIGGER_DONE_DATA 0x18
#define CONTROL_BITS_TRIGGER_DONE_DATA 1
