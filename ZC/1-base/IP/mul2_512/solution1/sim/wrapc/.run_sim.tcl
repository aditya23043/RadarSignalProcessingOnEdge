...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mul512.autotvin.dat"
	set constFileTvOut       "mul512.autotvout.dat"
	set constFileHdlTvIn     "mul512.autohdltvin.dat"
	set constFileHdlTvOut    "mul512.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
