...
HD_PWD='/mnt/arch/home/adi/repo/AELD_Lab_2026/as_close_as_midsem/vivado_zc_full_opt_acp/vivado_zc_full_opt_acp.runs/design_1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
