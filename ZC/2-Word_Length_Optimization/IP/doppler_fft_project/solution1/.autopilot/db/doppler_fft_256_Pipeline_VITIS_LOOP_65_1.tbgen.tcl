set moduleName doppler_fft_256_Pipeline_VITIS_LOOP_65_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {doppler_fft_256_Pipeline_VITIS_LOOP_65_1}
...
set C_modelArgList {
	...
	{ buf_M_real_V int 19 regular {array 256 { 0 3 } 0 1 }  }
	{ buf_M_imag_V int 19 regular {array 256 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_r_V_data_V", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "buf_M_real_V", "interface" : "memory", "bitwidth" : 19, "direction" : "WRITEONLY"} , 
 	{ "Name" : "buf_M_imag_V", "interface" : "memory", "bitwidth" : 19, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ buf_M_real_V_address0 sc_out sc_lv 8 signal 4 } 
	{ buf_M_real_V_ce0 sc_out sc_logic 1 signal 4 } 
	{ buf_M_real_V_we0 sc_out sc_logic 1 signal 4 } 
	{ buf_M_real_V_d0 sc_out sc_lv 19 signal 4 } 
	{ buf_M_imag_V_address0 sc_out sc_lv 8 signal 5 } 
	{ buf_M_imag_V_ce0 sc_out sc_logic 1 signal 5 } 
	{ buf_M_imag_V_we0 sc_out sc_logic 1 signal 5 } 
	{ buf_M_imag_V_d0 sc_out sc_lv 19 signal 5 } 
	{ grp_fu_110_p_din0 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_110_p_din1 sc_out sc_lv 32 signal -1 } 
	{ grp_fu_110_p_dout0 sc_in sc_lv 32 signal -1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "grp_fu_110_p_din0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_fu_110_p_din0", "role": "default" }} , 
 	{ "name": "grp_fu_110_p_din1", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_fu_110_p_din1", "role": "default" }} , 
 	{ "name": "grp_fu_110_p_dout0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "grp_fu_110_p_dout0", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.fpext_32ns_64_2_no_dsp_1_U4", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	buf_M_real_V { ap_memory {  { buf_M_real_V_address0 mem_address 1 8 }  { buf_M_real_V_ce0 mem_ce 1 1 }  { buf_M_real_V_we0 mem_we 1 1 }  { buf_M_real_V_d0 mem_din 1 19 } } }
	buf_M_imag_V { ap_memory {  { buf_M_imag_V_address0 mem_address 1 8 }  { buf_M_imag_V_ce0 mem_ce 1 1 }  { buf_M_imag_V_we0 mem_we 1 1 }  { buf_M_imag_V_d0 mem_din 1 19 } } }
}
