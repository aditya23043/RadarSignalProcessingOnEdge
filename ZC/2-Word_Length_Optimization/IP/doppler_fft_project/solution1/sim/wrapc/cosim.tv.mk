...
$(ObjDir)/doppler_fft_tb.cpp_pre.cpp.tb.o : doppler_fft_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling doppler_fft_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/doppler_fft.cpp_pre.cpp.tb.o : doppler_fft.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling doppler_fft.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
