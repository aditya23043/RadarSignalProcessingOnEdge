...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "doppler_fft_top.autotvin.dat"
	set constFileTvOut       "doppler_fft_top.autotvout.dat"
	set constFileHdlTvIn     "doppler_fft_top.autohdltvin.dat"
	set constFileHdlTvOut    "doppler_fft_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
