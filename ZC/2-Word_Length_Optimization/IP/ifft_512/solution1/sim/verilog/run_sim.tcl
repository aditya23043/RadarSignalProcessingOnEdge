...
if {[file isfile ifft_512_top.autotvin.dat]} {
	file delete -force ifft_512_top.autotvin.dat
}

if {[file isfile ifft_512_top.autotvout.dat]} {
	file delete -force ifft_512_top.autotvout.dat
}
