...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ifft_512_top.autotvin.dat"
	set constFileTvOut       "ifft_512_top.autotvout.dat"
	set constFileHdlTvIn     "ifft_512_top.autohdltvin.dat"
	set constFileHdlTvOut    "ifft_512_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
