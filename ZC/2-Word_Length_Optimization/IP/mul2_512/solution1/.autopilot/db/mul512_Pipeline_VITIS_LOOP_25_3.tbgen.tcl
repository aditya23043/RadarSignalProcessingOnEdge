set moduleName mul512_Pipeline_VITIS_LOOP_25_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {mul512_Pipeline_VITIS_LOOP_25_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ output_zc_M_value float 32 regular {array 512 { 1 3 } 1 1 }  }
	{ output_zc_M_value_1 float 32 regular {array 512 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "output_zc_M_value", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "output_zc_M_value_1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ output_zc_M_value_address0 sc_out sc_lv 9 signal 0 } 
	{ output_zc_M_value_ce0 sc_out sc_logic 1 signal 0 } 
	{ output_zc_M_value_q0 sc_in sc_lv 32 signal 0 } 
	{ output_zc_M_value_1_address0 sc_out sc_lv 9 signal 1 } 
	{ output_zc_M_value_1_ce0 sc_out sc_logic 1 signal 1 } 
	{ output_zc_M_value_1_q0 sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "output_zc_M_value_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "output_zc_M_value", "role": "q0" }} , 
 	...
 	{ "name": "output_zc_M_value_1_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "output_zc_M_value_1", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	output_zc_M_value { ap_memory {  { output_zc_M_value_address0 mem_address 1 9 }  { output_zc_M_value_ce0 mem_ce 1 1 }  { output_zc_M_value_q0 in_data 0 32 } } }
	output_zc_M_value_1 { ap_memory {  { output_zc_M_value_1_address0 mem_address 1 9 }  { output_zc_M_value_1_ce0 mem_ce 1 1 }  { output_zc_M_value_1_q0 in_data 0 32 } } }
