...
HD_PWD='/mnt/arch/home/adi/repo/AELD_Lab_2026/HLS_WLO/Vivado_golay_WLO_corr_full/Vivado_golay_WLO_corr_full.runs/design_1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
