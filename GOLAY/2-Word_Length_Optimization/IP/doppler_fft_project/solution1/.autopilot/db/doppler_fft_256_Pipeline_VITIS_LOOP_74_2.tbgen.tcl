set moduleName doppler_fft_256_Pipeline_VITIS_LOOP_74_2
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {doppler_fft_256_Pipeline_VITIS_LOOP_74_2}
set C_modelType { void 0 }
set C_modelArgList {
	{ buf_M_real_V int 19 regular {array 256 { 1 3 } 1 1 }  }
	{ buf_M_imag_V int 19 regular {array 256 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "buf_M_real_V", "interface" : "memory", "bitwidth" : 19, "direction" : "READONLY"} , 
 	{ "Name" : "buf_M_imag_V", "interface" : "memory", "bitwidth" : 19, "direction" : "READONLY"} , 
...
set Spec2ImplPortList { 
	buf_M_real_V { ap_memory {  { buf_M_real_V_address0 mem_address 1 8 }  { buf_M_real_V_ce0 mem_ce 1 1 }  { buf_M_real_V_q0 in_data 0 19 } } }
	buf_M_imag_V { ap_memory {  { buf_M_imag_V_address0 mem_address 1 8 }  { buf_M_imag_V_ce0 mem_ce 1 1 }  { buf_M_imag_V_q0 in_data 0 19 } } }
