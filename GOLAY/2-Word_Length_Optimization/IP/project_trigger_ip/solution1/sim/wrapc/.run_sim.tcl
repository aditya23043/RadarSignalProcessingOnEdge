...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "trigger_ip.autotvin.dat"
	set constFileTvOut       "trigger_ip.autotvout.dat"
	set constFileHdlTvIn     "trigger_ip.autohdltvin.dat"
	set constFileHdlTvOut    "trigger_ip.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
