set moduleName fft_1024_top_Pipeline_VITIS_LOOP_72_4
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {fft_1024_top_Pipeline_VITIS_LOOP_72_4}
set C_modelType { void 0 }
set C_modelArgList {
	{ gb_M_real_V int 26 regular {array 1024 { 1 3 } 1 1 }  }
	{ gb_M_imag_V int 26 regular {array 1024 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gb_M_real_V", "interface" : "memory", "bitwidth" : 26, "direction" : "READONLY"} , 
 	{ "Name" : "gb_M_imag_V", "interface" : "memory", "bitwidth" : 26, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ gb_M_real_V_address0 sc_out sc_lv 10 signal 0 } 
	{ gb_M_real_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ gb_M_real_V_q0 sc_in sc_lv 26 signal 0 } 
	{ gb_M_imag_V_address0 sc_out sc_lv 10 signal 1 } 
	{ gb_M_imag_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ gb_M_imag_V_q0 sc_in sc_lv 26 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "gb_M_real_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "gb_M_real_V", "role": "q0" }} , 
 	...
 	{ "name": "gb_M_imag_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":26, "type": "signal", "bundle":{"name": "gb_M_imag_V", "role": "q0" }} , 
...
set Spec2ImplPortList { 
	gb_M_real_V { ap_memory {  { gb_M_real_V_address0 mem_address 1 10 }  { gb_M_real_V_ce0 mem_ce 1 1 }  { gb_M_real_V_q0 in_data 0 26 } } }
	gb_M_imag_V { ap_memory {  { gb_M_imag_V_address0 mem_address 1 10 }  { gb_M_imag_V_ce0 mem_ce 1 1 }  { gb_M_imag_V_q0 in_data 0 26 } } }
