...
unsigned int ap_apatb__cap_bc;
static AESL_RUNTIME_BC __xlx__V_size_Reader("../tv/stream_size/stream_size_out_.dat");
extern "C" void fft_1024_top(volatile void *, volatile void *, volatile void *, , volatile void *, , , volatile void *, volatile void *, volatile void *, , volatile void *, , );
...
auto* soutput_V_last_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_output_V_last_V);
  // DUT call
  fft_1024_top(sinput_V_data_V->data<long long>(), sinput_V_keep_V->data<char>(), sinput_V_strb_V->data<char>(), sinput_V_last_V->data<char>(), soutput_V_data_V->data<long long>(), soutput_V_keep_V->data<char>(), soutput_V_strb_V->data<char>(), soutput_V_last_V->data<char>());
