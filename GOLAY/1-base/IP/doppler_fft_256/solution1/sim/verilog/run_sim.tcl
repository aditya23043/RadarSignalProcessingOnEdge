...
if {[file isfile doppler_fft_256.autotvin.dat]} {
	file delete -force doppler_fft_256.autotvin.dat
}

if {[file isfile doppler_fft_256.autotvout.dat]} {
	file delete -force doppler_fft_256.autotvout.dat
}
