...
set name corr_multiplication_fsub_32ns_32ns_32_5_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fsub} IMPL {fulldsp} LATENCY 4 ALLOW_PRAGMA 1
}


set name corr_multiplication_fadd_32ns_32ns_32_5_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fadd} IMPL {fulldsp} LATENCY 4 ALLOW_PRAGMA 1
}


set name corr_multiplication_fmul_32ns_32ns_32_4_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { input_r_TDATA { I 64 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { output_r_TDATA { O 64 vector } } \
} "
} else {
...
# RegSlice definition:
set ID 53
set RegSliceName corr_multiplication_regslice_both
set RegSliceInstName corr_multiplication_regslice_both_U
set CoreName ap_simcore_corr_multiplication_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
