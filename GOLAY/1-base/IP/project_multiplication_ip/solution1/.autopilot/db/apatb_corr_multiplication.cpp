...
#define AUTOTB_TVOUT_input_r_V_data_V "../tv/cdatafile/c.corr_multiplication.autotvout_input_r_V_data_V.dat"
#define AUTOTB_TVIN_input_r_V_keep_V "../tv/cdatafile/c.corr_multiplication.autotvin_input_r_V_keep_V.dat"
#define AUTOTB_TVOUT_input_r_V_keep_V "../tv/cdatafile/c.corr_multiplication.autotvout_input_r_V_keep_V.dat"
#define AUTOTB_TVIN_input_r_V_strb_V "../tv/cdatafile/c.corr_multiplication.autotvin_input_r_V_strb_V.dat"
#define AUTOTB_TVOUT_input_r_V_strb_V "../tv/cdatafile/c.corr_multiplication.autotvout_input_r_V_strb_V.dat"
#define AUTOTB_TVIN_input_r_V_last_V "../tv/cdatafile/c.corr_multiplication.autotvin_input_r_V_last_V.dat"
#define AUTOTB_TVOUT_input_r_V_last_V "../tv/cdatafile/c.corr_multiplication.autotvout_input_r_V_last_V.dat"
...
#define AUTOTB_TVIN_output_r_V_data_V "../tv/cdatafile/c.corr_multiplication.autotvin_output_r_V_data_V.dat"
#define AUTOTB_TVOUT_output_r_V_data_V "../tv/cdatafile/c.corr_multiplication.autotvout_output_r_V_data_V.dat"
#define AUTOTB_TVIN_output_r_V_keep_V "../tv/cdatafile/c.corr_multiplication.autotvin_output_r_V_keep_V.dat"
#define AUTOTB_TVOUT_output_r_V_keep_V "../tv/cdatafile/c.corr_multiplication.autotvout_output_r_V_keep_V.dat"
#define AUTOTB_TVIN_output_r_V_strb_V "../tv/cdatafile/c.corr_multiplication.autotvin_output_r_V_strb_V.dat"
#define AUTOTB_TVOUT_output_r_V_strb_V "../tv/cdatafile/c.corr_multiplication.autotvout_output_r_V_strb_V.dat"
#define AUTOTB_TVIN_output_r_V_last_V "../tv/cdatafile/c.corr_multiplication.autotvin_output_r_V_last_V.dat"
...
// tvout file define:
#define AUTOTB_TVOUT_PC_input_r_V_data_V "../tv/rtldatafile/rtl.corr_multiplication.autotvout_input_r_V_data_V.dat"
#define AUTOTB_TVOUT_PC_input_r_V_keep_V "../tv/rtldatafile/rtl.corr_multiplication.autotvout_input_r_V_keep_V.dat"
#define AUTOTB_TVOUT_PC_input_r_V_strb_V "../tv/rtldatafile/rtl.corr_multiplication.autotvout_input_r_V_strb_V.dat"
#define AUTOTB_TVOUT_PC_input_r_V_last_V "../tv/rtldatafile/rtl.corr_multiplication.autotvout_input_r_V_last_V.dat"
#define AUTOTB_TVOUT_PC_output_r_V_data_V "../tv/rtldatafile/rtl.corr_multiplication.autotvout_output_r_V_data_V.dat"
#define AUTOTB_TVOUT_PC_output_r_V_keep_V "../tv/rtldatafile/rtl.corr_multiplication.autotvout_output_r_V_keep_V.dat"
#define AUTOTB_TVOUT_PC_output_r_V_strb_V "../tv/rtldatafile/rtl.corr_multiplication.autotvout_output_r_V_strb_V.dat"
#define AUTOTB_TVOUT_PC_output_r_V_last_V "../tv/rtldatafile/rtl.corr_multiplication.autotvout_output_r_V_last_V.dat"
...
extern "C" void corr_multiplication_hw_stub_wrapper(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);

extern "C" void apatb_corr_multiplication_hw(volatile void * __xlx_apatb_param_input_V_data_V, volatile void * __xlx_apatb_param_input_V_keep_V, volatile void * __xlx_apatb_param_input_V_strb_V, volatile void * __xlx_apatb_param_input_V_last_V, volatile void * __xlx_apatb_param_output_V_data_V, volatile void * __xlx_apatb_param_output_V_keep_V, volatile void * __xlx_apatb_param_output_V_strb_V, volatile void * __xlx_apatb_param_output_V_last_V) {
...
((hls::stream<long long>*)__xlx_apatb_param_input_V_data_V)->read();
...
{unsigned xlx_stream_output_r_size = 0;
          ...
          std::vector<sc_bv<64> > output_r_V_data_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<64> > output_r_V_data_V_pc_buffer;
          int i = 0;
...
output_r_V_data_V_pc_buffer_Copy=output_r_V_data_V_pc_buffer;
          ...
          std::vector<sc_bv<64> > output_r_V_keep_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<64> > output_r_V_keep_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
...
output_r_V_keep_V_pc_buffer_Copy=output_r_V_keep_V_pc_buffer;
          ...
          std::vector<sc_bv<64> > output_r_V_strb_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<64> > output_r_V_strb_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
...
output_r_V_strb_V_pc_buffer_Copy=output_r_V_strb_V_pc_buffer;
          ...
          std::vector<sc_bv<64> > output_r_V_last_V_pc_buffer_Copy;
{
      static ifstream rtl_tv_out_file;
      if (!rtl_tv_out_file.is_open()) {
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<64> > output_r_V_last_V_pc_buffer;
          int i = 0;
          bool has_unknown_value = false;
          rtl_tv_out_file >> AESL_token; //data
          while (AESL_token != "[[/transaction]]"){
...
((long long*)&xlx_stream_elt_data)[0] = output_r_V_data_V_pc_buffer_Copy[j].to_int64();
((hls::stream<long long>*)__xlx_apatb_param_output_V_data_V)->write(xlx_stream_elt_data);
...
// data
std::vector<long long> __xlx_apatb_param_input_V_data_V_stream_buf;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_input_V_data_V)->empty())
    __xlx_apatb_param_input_V_data_V_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_input_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_input_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_input_V_data_V)->write(__xlx_apatb_param_input_V_data_V_stream_buf[i]);
  }
long __xlx_apatb_param_input_r_stream_buf_size = ((hls::stream<long long>*)__xlx_apatb_param_input_V_data_V)->size();
// keep
...
// dest
// data
std::vector<long long> __xlx_apatb_param_output_V_data_V_stream_buf;
long __xlx_apatb_param_output_r_stream_buf_size = ((hls::stream<long long>*)__xlx_apatb_param_output_V_data_V)->size();
// keep
...
corr_multiplication_hw_stub_wrapper(__xlx_apatb_param_input_V_data_V, __xlx_apatb_param_input_V_keep_V, __xlx_apatb_param_input_V_strb_V, __xlx_apatb_param_input_V_last_V, __xlx_apatb_param_output_V_data_V, __xlx_apatb_param_output_V_keep_V, __xlx_apatb_param_output_V_strb_V, __xlx_apatb_param_output_V_last_V);
CodeState = DUMP_OUTPUTS;
long __xlx_apatb_param_input_r_stream_buf_final_size = __xlx_apatb_param_input_r_stream_buf_size - ((hls::stream<long long>*)__xlx_apatb_param_input_V_data_V)->size();
...
for (int i = 0; i < __xlx_apatb_param_input_r_stream_buf_final_size; ++i) {
  std::string s;
s = formatData((unsigned char*)(__xlx_apatb_param_input_V_data_V_stream_buf.data()+i), 64);
aesl_fh.write(AUTOTB_TVIN_input_r_V_data_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_input_V_keep_V_stream_buf.data()+i), 8);
aesl_fh.write(AUTOTB_TVIN_input_r_V_keep_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_input_V_strb_V_stream_buf.data()+i), 8);
...
long __xlx_apatb_param_output_r_stream_buf_final_size = ((hls::stream<long long>*)__xlx_apatb_param_output_V_data_V)->size() - __xlx_apatb_param_output_r_stream_buf_size;
{
  while (!((hls::stream<long long>*)__xlx_apatb_param_output_V_data_V)->empty())
    __xlx_apatb_param_output_V_data_V_stream_buf.push_back(((hls::stream<long long>*)__xlx_apatb_param_output_V_data_V)->read());
  for (int i = 0; i < __xlx_apatb_param_output_V_data_V_stream_buf.size(); ++i)
    ((hls::stream<long long>*)__xlx_apatb_param_output_V_data_V)->write(__xlx_apatb_param_output_V_data_V_stream_buf[i]);
  }
{
...
for (int i = 0; i < __xlx_apatb_param_output_r_stream_buf_final_size; ++i) {
  std::string s;
s = formatData((unsigned char*)(__xlx_apatb_param_output_V_data_V_stream_buf.data()+__xlx_apatb_param_output_r_stream_buf_size+i), 64);
aesl_fh.write(AUTOTB_TVOUT_output_r_V_data_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_output_V_keep_V_stream_buf.data()+__xlx_apatb_param_output_r_stream_buf_size+i), 8);
aesl_fh.write(AUTOTB_TVOUT_output_r_V_keep_V, s);
s = formatData((unsigned char*)(__xlx_apatb_param_output_V_strb_V_stream_buf.data()+__xlx_apatb_param_output_r_stream_buf_size+i), 8);
