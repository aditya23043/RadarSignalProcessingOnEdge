...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.corr_multiplication.autotvin_input_r_V_data_V.dat"
         "c.corr_multiplication.autotvin_input_r_V_keep_V.dat"
         "c.corr_multiplication.autotvin_input_r_V_strb_V.dat"
         "c.corr_multiplication.autotvin_input_r_V_last_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.corr_multiplication.autotvout_output_r_V_data_V.dat"
         "rtl.corr_multiplication.autotvout_output_r_V_keep_V.dat"
         "rtl.corr_multiplication.autotvout_output_r_V_strb_V.dat"
         "rtl.corr_multiplication.autotvout_output_r_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
