...
`define TV_OUT_output_r_TDATA "../tv/rtldatafile/rtl.corr_multiplication.autotvout_output_r_V_data_V.dat"
`define EGRESS_STATUS_output_r_TDATA "../tv/stream_size/stream_egress_status_output_r_V_data_V.dat"
`define TV_OUT_output_r_TKEEP "../tv/rtldatafile/rtl.corr_multiplication.autotvout_output_r_V_keep_V.dat"
`define EGRESS_STATUS_output_r_TKEEP "../tv/stream_size/stream_egress_status_output_r_V_keep_V.dat"
`define TV_OUT_output_r_TSTRB "../tv/rtldatafile/rtl.corr_multiplication.autotvout_output_r_V_strb_V.dat"
`define EGRESS_STATUS_output_r_TSTRB "../tv/stream_size/stream_egress_status_output_r_V_strb_V.dat"
`define TV_OUT_output_r_TLAST "../tv/rtldatafile/rtl.corr_multiplication.autotvout_output_r_V_last_V.dat"
`define EGRESS_STATUS_output_r_TLAST "../tv/stream_size/stream_egress_status_output_r_V_last_V.dat"
...
module AESL_axi_s_output_r (
    input clk,
    input reset,
    input [64 - 1:0] TRAN_output_r_TDATA,
    input [8 - 1:0] TRAN_output_r_TKEEP,
    input [8 - 1:0] TRAN_output_r_TSTRB,
    ...
    reg [64 - 1:0] output_r_TDATA_write_data;
    reg output_r_TDATA_read_en;
    wire [64 - 1:0] output_r_TDATA_read_data;
    
    fifo #(2048, 64) fifo_output_r_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [8 - 1:0] output_r_TKEEP_write_data;
    reg output_r_TKEEP_read_en;
    wire [8 - 1:0] output_r_TKEEP_read_data;
    
    fifo #(2048, 8) fifo_output_r_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    reg [8 - 1:0] output_r_TSTRB_write_data;
    reg output_r_TSTRB_read_en;
    wire [8 - 1:0] output_r_TSTRB_read_data;
    
    fifo #(2048, 8) fifo_output_r_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2048, 1) fifo_output_r_TLAST (
        .reset(1'b0),
        .write_clock(clk),
