...
if {[file isfile corr_multiplication.autotvin.dat]} {
	file delete -force corr_multiplication.autotvin.dat
}

if {[file isfile corr_multiplication.autotvout.dat]} {
	file delete -force corr_multiplication.autotvout.dat
}
