...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "corr_multiplication.autotvin.dat"
	set constFileTvOut       "corr_multiplication.autotvout.dat"
	set constFileHdlTvIn     "corr_multiplication.autohdltvin.dat"
	set constFileHdlTvOut    "corr_multiplication.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
