...
if {[file isfile ifft_1024_top.autotvin.dat]} {
	file delete -force ifft_1024_top.autotvin.dat
}

if {[file isfile ifft_1024_top.autotvout.dat]} {
	file delete -force ifft_1024_top.autotvout.dat
}
