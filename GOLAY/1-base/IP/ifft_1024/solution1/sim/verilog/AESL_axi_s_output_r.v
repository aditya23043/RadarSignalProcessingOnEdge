...
`define TV_OUT_output_r_TDATA "../tv/rtldatafile/rtl.ifft_1024_top.autotvout_output_r_V_data_V.dat"
`define EGRESS_STATUS_output_r_TDATA "../tv/stream_size/stream_egress_status_output_r_V_data_V.dat"
`define TV_OUT_output_r_TKEEP "../tv/rtldatafile/rtl.ifft_1024_top.autotvout_output_r_V_keep_V.dat"
`define EGRESS_STATUS_output_r_TKEEP "../tv/stream_size/stream_egress_status_output_r_V_keep_V.dat"
`define TV_OUT_output_r_TSTRB "../tv/rtldatafile/rtl.ifft_1024_top.autotvout_output_r_V_strb_V.dat"
`define EGRESS_STATUS_output_r_TSTRB "../tv/stream_size/stream_egress_status_output_r_V_strb_V.dat"
`define TV_OUT_output_r_TLAST "../tv/rtldatafile/rtl.ifft_1024_top.autotvout_output_r_V_last_V.dat"
...
module AESL_axi_s_output_r (
    ...
    fifo #(1024, 64) fifo_output_r_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1024, 8) fifo_output_r_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1024, 8) fifo_output_r_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(1024, 1) fifo_output_r_TLAST (
        .reset(1'b0),
        .write_clock(clk),
