...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "ifft_1024_top.autotvin.dat"
	set constFileTvOut       "ifft_1024_top.autotvout.dat"
	set constFileHdlTvIn     "ifft_1024_top.autohdltvin.dat"
	set constFileHdlTvOut    "ifft_1024_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
