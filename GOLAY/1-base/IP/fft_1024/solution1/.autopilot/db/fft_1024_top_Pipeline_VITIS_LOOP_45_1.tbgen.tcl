set moduleName fft_1024_top_Pipeline_VITIS_LOOP_45_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {fft_1024_top_Pipeline_VITIS_LOOP_45_1}
...
set C_modelArgList {
	...
	{ ga_M_value float 32 regular {array 1024 { 0 3 } 0 1 }  }
	{ ga_M_value_1 float 32 regular {array 1024 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "input_r_V_data_V", "interface" : "axis", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ga_M_value", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "ga_M_value_1", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ ga_M_value_address0 sc_out sc_lv 10 signal 4 } 
	{ ga_M_value_ce0 sc_out sc_logic 1 signal 4 } 
	{ ga_M_value_we0 sc_out sc_logic 1 signal 4 } 
	{ ga_M_value_d0 sc_out sc_lv 32 signal 4 } 
	{ ga_M_value_1_address0 sc_out sc_lv 10 signal 5 } 
	{ ga_M_value_1_ce0 sc_out sc_logic 1 signal 5 } 
	{ ga_M_value_1_we0 sc_out sc_logic 1 signal 5 } 
	{ ga_M_value_1_d0 sc_out sc_lv 32 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ga_M_value_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ga_M_value", "role": "we0" }} , 
 	{ "name": "ga_M_value_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ga_M_value", "role": "d0" }} , 
 	...
 	{ "name": "ga_M_value_1_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ga_M_value_1", "role": "we0" }} , 
 	{ "name": "ga_M_value_1_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "ga_M_value_1", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	ga_M_value { ap_memory {  { ga_M_value_address0 mem_address 1 10 }  { ga_M_value_ce0 mem_ce 1 1 }  { ga_M_value_we0 mem_we 1 1 }  { ga_M_value_d0 mem_din 1 32 } } }
	ga_M_value_1 { ap_memory {  { ga_M_value_1_address0 mem_address 1 10 }  { ga_M_value_1_ce0 mem_ce 1 1 }  { ga_M_value_1_we0 mem_we 1 1 }  { ga_M_value_1_d0 mem_din 1 32 } } }
}
