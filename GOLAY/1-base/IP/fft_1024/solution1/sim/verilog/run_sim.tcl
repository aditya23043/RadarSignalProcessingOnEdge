...
if {[file isfile fft_1024_top.autotvin.dat]} {
	file delete -force fft_1024_top.autotvin.dat
}

if {[file isfile fft_1024_top.autotvout.dat]} {
	file delete -force fft_1024_top.autotvout.dat
}
