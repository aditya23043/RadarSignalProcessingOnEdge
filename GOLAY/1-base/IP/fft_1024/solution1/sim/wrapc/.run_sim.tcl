...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "fft_1024_top.autotvin.dat"
	set constFileTvOut       "fft_1024_top.autotvout.dat"
	set constFileHdlTvIn     "fft_1024_top.autohdltvin.dat"
	set constFileHdlTvOut    "fft_1024_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
